...
async function main() {
    ...
    if (!agent) {
        ...
        const properties = [
            {
                ...
                bedrooms: 3,
                bathrooms: 2.5,
                description: "Beautiful modern family home in Round Rock with stunning neighborhood views and luxury amenities. Features an open floor plan, updated kitchen, and spacious backyard perfect for family gatherings."
            },
            {
                ...
                bedrooms: 5,
                bathrooms: 4.5,
                description: "Spacious luxury family estate with large backyard, gourmet kitchen, and excellent school district. This stunning home offers premium finishes and plenty of space for growing families."
            },
            {
                ...
                bedrooms: 4,
                bathrooms: 2,
                description: "Charming family home in South Austin with character and charm. Features a cozy fireplace, mature trees, and a welcoming neighborhood atmosphere perfect for families."
            },
            {
                ...
                bedrooms: 3,
                bathrooms: 2.5,
                description: "Perfect family home with modern updates, fenced yard, and convenient location near shopping and schools. Great starter home for growing families."
            },
            {
                ...
                bedrooms: 5,
                bathrooms: 4,
                description: "Large family home with plenty of space for everyone. Features multiple living areas, a chef's kitchen, and a beautiful backyard perfect for entertaining."
            },
            {
                ...
                bedrooms: 4,
                bathrooms: 3,
                description: "Beautifully maintained family home with original charm and modern amenities. Located in a quiet neighborhood with excellent schools and convenient access to shopping."
            },
            {
                ...
                bedrooms: 3,
                bathrooms: 2,
                description: "Affordable family home in a peaceful neighborhood with great potential. Features a cozy fireplace, fenced yard, and is close to parks and schools."
            },
            {
                ...
                bedrooms: 2,
                bathrooms: 2,
                description: "Charming family home in San Marcos with character and charm. Features a welcoming front porch, mature landscaping, and a peaceful neighborhood setting."
            },
            {
                ...
                bedrooms: 2,
                bathrooms: 1,
                description: "Cozy family home with beautiful landscaping, private patio, and peaceful surroundings. Perfect for small families or first-time homebuyers."
            },
            {
                ...
                bedrooms: 4,
                bathrooms: 4,
                description: "Spacious family home with plenty of room for everyone. Features multiple bedrooms, updated bathrooms, and a large backyard perfect for family activities and entertaining."
            }
        ];
        ...
        console.log(`Created ${properties.length} properties for agent ${agent.name}`);
    }
}
